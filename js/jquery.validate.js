...
$.extend( $.validator, {
	...
	messages: {
		...
		equalTo: "上の項目と異なる値が入力されています",
		maxlength: $.validator.format( " {0} 文字以下で入力して下さい" ),
		minlength: $.validator.format( " {0} 文字以上で入力して下さい" ),
		rangelength: $.validator.format( " {0} 文字から {1} 文字で入力して下さい" ),
		range: $.validator.format( " {0} から {1} の半角数字で入力して下さい" ),
		max: $.validator.format( " {0}以下の半角数字で入力して下さい" ),
		min: $.validator.format( " {0}以上の半角数字で入力して下さい" ),
		// 白坂追記2016/01/03
		alphanumericsymbol: "半角英数字記号で入力して下さい"
	},
